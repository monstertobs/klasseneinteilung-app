...
"%APP_DIR%python-portable\python.exe" -m pip install --no-warn-script-location "--target=%APP_DIR%python-portable\Lib\site-packages" Flask==3.0.0 Flask-Login==0.6.3 Flask-WTF==1.2.1 Werkzeug==3.0.1 Flask-Limiter==3.5.0 Flask-Session==0.8.0 python-dotenv==1.0.0 openpyxl==3.1.2 reportlab==4.0.9 requests==2.31.0 >nul 2>&1
